...
tar -cvzf /home/pierrick/SOD/date-`date +%Y-%m-%d-%H-%M`.tar.gz "/home/" "/var/sftp/" "/var/mail" "/var/www" "/etc/apache2" "/etc/prosody" "/etc/tinydns/root" "/etc/courier" "/etc/mysql" "/etc/phpmyadmin" " /etc/ssh/sftp_config"
