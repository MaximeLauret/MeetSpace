        ...
        <div class="cover-container">
          ...
          <div class="masthead clearfix">
            ...
            <div class="container">
              ...
              <div class="col-xs-12 col-sm-9 col-md-9 col-lg-7 col-lg-offset" 
              style="background-color:#174146;height:200px;">



              </div>
              <div class="col-xs-12 col-sm-3 col-md-3 col-lg-4 col-lg-offset-1" 
