      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="masthead clearfix">
            <div class="inner">
              <h3 class="masthead-brand" >MeetSpace</h3>
              <nav>
          ...
          <div class="inner cover">
              <h1 class="cover-heading">Découvrez ce que vous offre Meetspace:</h1>
            
            <div class="btn-group-vertical">
              <br>
              <a href="http://share.meetspace.itinet.fr" class="btn btn-lg btn-default">Un répertoire partagé</a>
              <br>
              <a href="http://meetspace.itinet.fr:9001" class="btn btn-lg btn-default">Un espace de travail collaboratif</a>
              <br>
              <a href="http://mail.meetspace.itinet.fr" class="btn btn-lg btn-default">Une adresse mail</a>
              <br>
              <a href="http://blog.meetspace.itinet.fr" class="btn btn-lg btn-default">L'hébergement d'un blog de développement</a>
              <br>
              <a href="http://admin.blog.meetspace.itinet.fr" class="btn btn-lg btn-default">Administrable depuis le panel de gestion</a>
              <br>
              <a href="http://phpmyadmin.meetspace.itinet.fr" class="btn btn-lg btn-default">Une gestion graphique de votre base de données</a>
              <br>
              <a href="#" class="btn btn-lg btn-default">Un système de tchat intégré</a>

              <a href="/" class="btn btn-lg btn-inverse">Retour</a>
              <br>
            </div>
          ...
          <div class="mastfoot">
            <div class="inner">
              <p>Réalisé par Pierrick VERAN à l'aide de <a href="http://getbootstrap.com/">Bootstrap</a>.
            </div>
          </div>
